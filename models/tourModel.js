...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour must contain 40 characters max'],
      minlength: [10, 'A tour must contain 10 characters min'],
      // validate: [validator.isAlpha, 'A name should contail only characters'],
    },
    slug: String,
    duration: {
      type: Number,
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficulty needs to be easy medium or difficult',
      },
    },
    ratingsAverage: {
      type: Number,
