...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidXJpLWtvZmZtYW4iLCJhIjoiY2xpZWhybTBhMDloOTNkcDYzbnJxM2pldyJ9.0BPCZq2_GDIFUrrNt5FZOw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/uri-koffman/cliejtcig004o01pf5rpheeq0',
    scrollZoom: false
  });
...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51NGIQuEFoC6IpBaioj3EQFt1H3m1ojjUoyG9k9uRCDE6l6UuwT2quZtymsPLhDHliHd10wall5c3KV0ihiVuX70100Gwc6El0l');
          _context.prev = 1;
          _context.next = 4;
